...
class General(Extension):
    ...
    async def template(self, ctx: InteractionContext):
        ...
        e.set_image(
            url="https://cdn.discordapp.com/attachments/804388848510435370/827998690886418463/ezgif-7-c601e2fb575f.gif")
    ...
    async def help(self, ctx: InteractionContext):
        ...
        embed.set_author(name="Studybot Commands List",
                         icon_url=ctx.bot.user.avatar.url, url="https://www.studybot.ca/")
        embed.set_thumbnail(
